...
const ModalCartoes: React.FC<ModalCartoesProps> = ({
  tipo,
  cartao,
  onClose,
}) => {
  ...
  const renderCartao = () => {
    const cor =
      cartao === "fisico" ? "bg-[var(--color-azul-escuro)]" : "bg-[#999999]";
    return (
      <div
        className={`w-[280px] h-[147px] rounded-lg ${cor} p-3 flex flex-col justify-between text-[var(--color-branco)] text-left font-sans italic mx-auto mb-4`}
      >
        <div>
    ...
    <>
      <div className="bg-[var(--color-fundo-principal)] w-full h-full sm:max-w-[665px] sm:h-[670px] p-6 sm:rounded-xl shadow-lg relative flex flex-col overflow-y-auto">
        ...
        <div className="mt-6 text-center">
          ...
          {tipo === "configurar" && (
            <>
              <p className="text-[var(--color-preto)] text-base font-bold mb-4">
              ...
              <div className="flex flex-col gap-4 items-start ml-[110px]">
                {[
                  ...
                  {
                    chave: "internacionais",
                    label: "Ativar/Desativar compras internacionais",
                  },
                  { chave: "debito", label: "Ativar/Desativar função débito" },
                  {
                    chave: "credito",
                    label: "Ativar/Desativar função crédito",
                  },
                ].map(({ chave, label }) => (
                  <label
                    key={chave}
                    className="flex items-center gap-3 text-sm text-[var(--color-preto)]"
                  >
                    <input
                      type="checkbox"
            ...
            <div className="text-center mt-4 flex flex-col items-center">
              ...
              <div className="flex justify-center gap-6 mb-10">
                ...
                <button
                  ...
                  className={`w-[180px] py-2 border-2 font-semibold rounded-md ${
                    bloqueado
