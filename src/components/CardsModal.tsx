...
const CardsModal = () => {
  ...
  const [tipoModal, setTipoModal] = useState<"configurar" | "bloquear" | null>(
    null
  );
  ...
  return (
    <section className="bg-cinza-escuro p-6 rounded-md w-full">
      ...
      {/* Cartão Físico */}
      <article className="flex flex-col md:flex-row w-full gap-10 items-start p-6 rounded-md mb-4">
      ...
      {/* Cartão Digital */}
      <article className="flex flex-col md:flex-row w-full gap-10 items-start p-6 rounded-md">
